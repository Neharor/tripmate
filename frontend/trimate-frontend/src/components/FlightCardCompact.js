...
export default function FlightCardCompact({ flight }) {
      ...
      >
        ...
        <Box sx={{ 
          ...
          <Box sx={{
            ...
            <FlightTakeoffIcon sx={{ fontSize: 30, color: '#3b82f6' }} />
          </Box>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            {!expanded && (
              <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap', alignItems: 'center' }}>
                ...
                {flight.return && (
                  <Chip label="Round Trip" size="small" sx={{ height: '20px', fontSize: '10px', ml: 0.5 }} />
                )}
              </Box>
            )}
          </Box>
